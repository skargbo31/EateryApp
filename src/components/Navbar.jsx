  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
            Best <span className='font-bold text-yellow-500'>Wilma Food Eats</span> 
        </h1>
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'  } >
            ...
            <h2 className='text-2xl p-4 '>Best <span className='font-bold text-yellow-500'>Wilma Food Eats</span> </h2>
            <nav>
                <ul className='flex flex-col p-4 text-gray-800 '>
                    ...
                    <li className='text-xl py-4 flex'><FaWallet className='mr-4' size={25}/> Wallets</li>
